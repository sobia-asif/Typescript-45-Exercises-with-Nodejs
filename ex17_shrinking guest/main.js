...
while (guestList.length > 2) {
    ...
    console.log("sorry, ".concat(removeGuest, " you can\u2019t invite you to dinner."));
}
//print two remaing name 
console.log("Invitation to the last  2 guest ");
guestList.forEach(function (invit) { return console.log("Luckly, ".concat(invit, "you are invited to dinner ")); });
